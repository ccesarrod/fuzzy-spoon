...
namespace NorthWind2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManager authenticationManager, ICustomerRepository customerRepository)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    var cartFromCookie=CookieHelper.GetCartFromCookie(HttpContext.Request.Cookies);
                    var currentCart =_customerRepository.SyncShoppingCart(model.Email, cartFromCookie);
                    CookieHelper.SaveCartToCookie(HttpContext.Response.Cookies, currentCart);
        ...
        {
            if (HttpContext.Response.Cookies["cart"] != null)
            {
